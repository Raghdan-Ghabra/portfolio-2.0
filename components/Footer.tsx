...
const Footer = async () => {
    const repoStats = await fetch(
        'https://api.github.com/repos/Raghdan/portfolio-2.0',
        {
            next: {
    ...
    return (
        <footer className="text-center pb-5" id="contact">
            <div className="container">
                ...
                <div className="">
                    <a
                        href="https://github.com/Raghdan/portfolio-2.0"
                        target="_blank"
                        className="leading-none text-muted-foreground hover:underline hover:text-white"
                    >
                       <span className="font-anton">Copyright © 2025 | <span className="text-primary">Eng. </span>Raghdan Ghabra</span>
                    ...
                    {/* Note: If you are not Raghdan, use this copyright message instead */}
